describe("lendsqr assessment", ()=>{
    ...
    it("user can register", ()=>{
        ...
        // register
            ...
            cy.findByTitle(/register_email_input/i).type("lendsqr@sqr.com")
    ...
    it("user can login", ()=>{
        ...
        // login
            cy.findByTitle(/login_email_input/i).type("lendsqr@sqr.com")
    ...
    it("user can update profile", ()=>{
        ...
        // complete profile
            ...
            cy.wait(3000);
            cy.findByTitle(/first_name/i).type("Lendsqr")
            cy.findByTitle(/last_name/i).type("Assessment")
